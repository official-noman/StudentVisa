...
urlpatterns = [
    ...
    path(
        "country_details/<int:country_id>/",
    ...
    path(
        "scholarship_singel_page/<int:scholarship_id>/",
    ...
    path(
        "country_wise_scholarship_single/<int:scw_id>/",
    ...
    path(
        "forgot_password_phone_or_email_student/",
    ...
    path(
        "change_forgotten_password_student/",
    ...
    path(
        "student_result_information/",
        views.student_result_information,
        name="student_result_information",
    ),
    path(
        "student_search_consultant/",
        views.student_search_consultant,
        name="student_search_consultant",
    ),
    path(
        "add_to_favorite/<int:consultant_id>/",
        views.add_to_favorite,
        name="add_to_favorite",
    ),
    path(
        "student_favourite_list/",
        views.student_favourite_list,
        name="student_favourite_list",
    ),
    path("student_profile/", views.student_profile, name="student_profile"),
    path(
        "edit_student_profile/", views.edit_student_profile, name="edit_student_profile"
    ),
    path(
        "delete_favourite_consultant/<int:consultant_id>/",
    ...
    path(
        "save_consultant_profile/<int:user_id>/",
    ...
    path(
        "view_students_by_consultant/<int:lead>/<int:student_id>/",
    ...
    path(
        "feedback_details_modal/<int:feedback_id>/",
    ...
    path(
        "compare_balance_with_lead/<int:lead>/<int:student_id>/",
    ...
    path(
        "delete_gallery/<int:image_id>/", Hodviews.delete_gallery, name="delete_gallery"
    ),
    ...
    path(
        "edit_consultant_wise_scholarship_list/<int:scholarship_id>/",
        Hodviews.edit_consultant_wise_scholarship_list,
        name="edit_consultant_wise_scholarship",
    ),
    path(
        "update_social_links/", Hodviews.update_social_links, name="update_social_links"
    ),
    # Root
    ...
    path(
        "delete_country/<int:country_id>/",
        rootviews.delete_country,
        name="delete_country",
    ),
    path(
        "consultant_wise_root/",
    ...
    path(
        "premium_user_details/<int:user_id>/",
    ...
    path(
        "active_student_details/<int:student_id>/",
        rootviews.active_student_details,
        name="active_student_details",
    ),
    path(
        "verify_student_account/<int:student_id>/",
    ...
    path(
        "verify_student_details/<int:student_id>/",
        rootviews.verify_student_details,
        name="verify_student_details",
    ),
    path(
        "consultant_credit_balance/",
    ...
    path(
        "edit_consultant_wise_scholarship/<int:scow_id>/",
        rootviews.edit_consultant_wise_scholarship,
        name="edit_consultant_wise_scholarship",
    ),
    path(
        "delete_consultant_wise_scholarship/<int:scow_id>/",
    ...
    path(
        "delete_scholarship_uploaded/<int:scholarship_id>/",
